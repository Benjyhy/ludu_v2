...
export const InlineTextIcon = ({ text, icon, inversed, background, btnMode, outline, iconColor, textColor }: IInlineTextIcon) => {
    return (
        <View style={[styles.inlineText, btnMode ? styles.btnMode : {}, outline ? styles.outline : {}, { backgroundColor: background }]}>
            {inversed ? (
                <>
